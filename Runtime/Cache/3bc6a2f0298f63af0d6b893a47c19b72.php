...
<body>
	...
	<div class="btn-group head-buttons" style="float:right;margin-right:19px;"><button class="btn btn-success btn-usercenter"><i class="icon-user"></i></button><button class="btn btn-success btn-msgcenter"><i class="icon-envelope"></i></button><button class="btn btn-warning warning" data-toggle="modal" data-target="#myModal"><i class="icon-off"></i></button></div></div>
	<div class="container">
		<div class="slides">
